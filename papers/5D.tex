...
%\acknowledgments       %< Commented because this is a command provided by JHEP. Decide whether to redefine this or
%remove acknowledgements from individual chapters.
