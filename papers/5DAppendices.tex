\chapter{Little group structure of type D Weyl spinor in five dimensions} \label{5D:SpinorConventions} 
%
This brief appendix is a companion to section \ref{5D:sec:ReviewSpinors5D} and gives details of calculations that
...
frame \eqref{5D:NullFrameMetric}. Effectively, this inverts the definition of the basis \eqref{5D:SpinorBasisDefn} in
...
matrices \eqref{5D:SpinorLorentzGeneratorsDefn}, we have
%
...
\end{equation}
%
The normalization of the spinor basis \eqref{5D:SpinorBasisNormalization} is equivalent to the following
...
\end{equation}
%
Substituting this back in \eqref{5D:SigmaComponentsStepOne}, and keeping in mind \eqref{5D:GammaContractionsPartOne}
and \eqref{5D:GammaContractionsPartTwo} we obtain
...
$\Psi_{ABCD}$ \eqref{5D:WeylLittleGroupObjects}, we obtain
%
\begin{equation} 
    \begin{split}
...
\eqref{5D:SigmaComponentsStepOne}, \eqref{5D:SigmaComponentsPartTwo},
\begin{equation} 
    \begin{split}
...
\eqref{5D:TypeDConditions} shows that with a properly chosen null frame $\Psi^{(0)}, \Psi^{(1)}, \Psi^{(3)}$ and
