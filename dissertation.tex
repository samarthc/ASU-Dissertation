...
%                                       %   'biblatex'
  \usepackage[style=phys,%              % Style option for AIP (default) or APS style
              %authordate,%
              backend=biber,%           % Recommend to use 'biber' instead of 'bibtex'
              pageranges=false,
              %doi=only,%               % Avoid printing URLs
              biblabel=brackets,%       % Use brackets for inline citations instead of
              ...
              \DeclareFieldFormat[article,inprceedings,thesis,unpublished]{title}{#1\isdot}
...
\hypersetup{                            % Set pdf metadata
 ...
 %pdfproducer={},                       % Let 'pdfproducer' be filled automatically
  ...
  %hidelinks={false},                     % Links are highlighted (changed by me)
