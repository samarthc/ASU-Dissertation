...
\newcommand*\defdate{January 2026}        %_<Give month (written out fully) and year of
                                        %   the oral defense
...
\newcommand{\bibheading}{References}    %_<Enter the heading for the references section:
