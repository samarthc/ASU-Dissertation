...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listadd{\titlelines}%
  {Explorations in the Classical Double Copy (Working Title)}             %_<Enter the title of the dissertation
\listadd{\titlelines}%
...
\listadd{\keywords}{keyword 1}          %_<Enter keywords; use \listadd for
