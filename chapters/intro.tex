...
duality}\footnote{The two names are used interchangeably throughout this dissertation.} \cite{Bern:2008qj}. BCJ
...
extent of the double copy proposal and hopefully learning something fundamental about the nature of gravitational
theories, the double copy has also found applications in other fields of physics \cite{Adamo:2022dcm}.
...
A rich area of inquiry within the double copy paradigm has been building out the double copy dictionary beyond simply
...
the double copy's horizon at $r = 2GM$ could be diagnosed. In particular, the gauge potential and the scalar field
...
directions} of the Weyl tensor. More precise statements about algebraic speciality are made in section
\ref{ssec:5DTypeD}.
...
existence of a local double copy relies strongly on algebraic speciality. 
